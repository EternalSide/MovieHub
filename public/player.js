...
function runKinoplayertop(sel) {
    ...
    l.setAttribute(
        'style',
        'position:absolute;left:0;top0; width:50%;height:50%;background:#' +
            bg +
    ...
    b.setAttribute(
        'style',
        'display: none;z-index:9999;position:absolute;left:0;top:0;width:50%;height:25%;background-color: #fc1100;background-image:linear-gradient( 20deg, #fa1100 0%, #' +
            bg +
            ' 100%);',
    );
    ...
    e.setAttribute(
        'style',
        'cursor:pointer;color:#721c24;background-color:#f8d7da;border-color:#f5c6cb;font-size:1.9vw;position:absolute;top: 0;left:0;padding: 0.75rem 1.25rem;margin-bottom: 1rem;border: 1px solid transparent;border-radius: 0.25rem;',
    );
    ...
    if (!classname) {
        i.setAttribute(
            'style',
            'position: absolute !important; top: 50% !important;top : 0 !important; left: 0 !important; right: 0!important; max-width:1920px !important; width: 100% !important; height: 50% !important; border: 0 !important; background: #000000;',
        );
    }
    i.onload = function () {
