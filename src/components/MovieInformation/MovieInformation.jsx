...
import { selectGenreOrCategory, selectCategoryName } from "../../features/currentGenreOrCategory";
  ...
  return (
    <Grid container className="movieinfo" alignItems="space-around">
            ...
            <div className="movieinfo__button-container">
              ...
              <Grid item xs={12} sm={6} className="movieinfo__button-container">
                <ButtonGroup size="medium" variant="outlined">
                  <Button onClick={addToFavourites} endIcon={isMovieFavourited ? <FavoriteIcon /> : <FavoriteBorderIcon />}>
      ...
      <Box marginTop="5rem" width="100%">
        ...
        {recommendations ? <MovieList movies={recommendations} numberOfMovies={12} recommendations /> : <Box>Ничего не найдено </Box>}
      </Box>
